...
select a.emp_no, a.first_name, d.first_name, c.dept_name
...
-- 문제8. (from 절에, 순수 join 문제)
-- 현재 자신의 매니저보다 높은 연봉을 받고 있는 직원은?
-- 부서이름, 사원이름, 연봉, 매니저 이름, 메니저 연봉 순으로 출력합니다.
select d.dept_name, a.first_name, b.salary, d.first_name, d.salary
from employees a, salaries b, dept_manager c,
	(select a.first_name, d.salary, b.dept_no, c.dept_name
	from employees a, dept_manager b, departments c, salaries d
	where a.emp_no = b.emp_no
    and b.dept_no = c.dept_no
    and a.emp_no = d.emp_no
	and b.to_date = '9999-01-01'
    and d.to_date = '9999-01-01') d
where a.emp_no = b.emp_no
and a.emp_no = c.emp_no
and c.dept_no = d.dept_no
and b.to_date = '9999-01-01'
